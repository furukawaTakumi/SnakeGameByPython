...
from test_module import field_test
from test_module import spec_reader_test
from test_module import game_controller_test
...
field_test.DoneAllTest()
game_controller_test.DoneAllTest()
